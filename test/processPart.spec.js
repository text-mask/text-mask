...
describe('processPart', () => {
  describe('accepted length 3', () => {
    ...
    ;[
      ...
      {input: '1___', output: '1__', remainder: '_'},
      {input: '11__', output: '11_', remainder: '_'},
      {input: '_1__', output: '_1_', remainder: '_'},
      {input: '1_1_', output: '1_1', remainder: '_'},
      {input: '1_1__', output: '1_1', remainder: '__'},
